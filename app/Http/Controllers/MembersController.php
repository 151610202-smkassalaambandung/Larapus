...
class MembersController extends Controller
{
    ...
    public function store(StoreMemberRequest $request)
    {
        ...
        Session::flash("flash_notification",["level"=>"success","message"=>"Berhasil menyimpan member dengan email" .
    ...
    public function update(UpdateMemberRequest $request, $id)
    {
        ...
        Session::flash("flash_notification", ["level"=>"success","message"=>"Berhasil menyimpan $member->name"]);
    ...
    public function destroy($id)
    {
        ...
        if ($member->hasRole('member')){
            $member->delete();
            Session::flash("flash_notification",["level"=>"success","message"=>"Member Berhasil dihapus"
                ]);
        }
